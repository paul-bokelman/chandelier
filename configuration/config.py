...
ConfigurationKeys = Literal[
    ...
    'candles_per_charge_cycle', 'charge_cycle_time', 'available_charging_hours', 'throttle_offset', 'calibration_counts', 'calibration_file_path', "skip_find_home", "uncalibrated_up_throttle", "uncalibrated_down_throttle", "max_recovery_attempts", "recovery_counts", "default_allowable_up_cps", 'default_allowable_down_cps', 'acceleration_buffer', 'stall_buffer', 'borderline_stall_zone', 'duration_before_recalibration', 'dead_motors', "c1", "c2", "random_params", "wave_params", "alternating_params", "charging_buffer_distance", "button_wait_time", "switch_wait_time"
]
