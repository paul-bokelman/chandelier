...
class Sequence:
    ...
    def random(self, iterations: int = 5) -> Generator[tuple[list[float], list[float]]]:
    ...
    def alternating(self, iterations: int = 5, amplitude: float = 0.4, translation: float = 0.3) -> Generator[tuple[list[float], list[float]]]:
